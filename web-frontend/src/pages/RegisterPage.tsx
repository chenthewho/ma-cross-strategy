    ...
    <div className="min-h-screen flex items-center justify-center relative px-4">
      ...
      <div className="relative z-10 w-full max-w-[400px] border border-white/10 backdrop-blur-xl bg-slate-900/60 rounded-2xl p-6 lg:p-8">
        <div className="text-center mb-6 lg:mb-8">
          ...
          <h1 className="text-xl lg:text-2xl font-bold text-[#e2e8f0] tracking-wider">{t('register.title')}</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-3 lg:space-y-4">
          <input type="email" required placeholder={t('login.email')}
            ...
            className="w-full px-3 lg:px-4 py-2.5 bg-slate-900/80 border border-slate-700 rounded-lg text-[#e2e8f0] text-sm focus:border-[#2dd4bf] focus:outline-none transition-colors placeholder:text-[#64748b]" />
