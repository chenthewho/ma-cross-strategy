...
export default function BacktestingPage() {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <h2 className="text-xl font-semibold text-[#e2e8f0]">{t('backtesting.title')}</h2>

      <Card className="p-6 space-y-4">
        <p className="text-sm text-[#94a3b8]">{t('backtesting.currentParams')}</p>
      ...
      {result && (
        <Card className="p-6 space-y-3">
          <h3 className="font-medium text-[#e2e8f0]">回测结果</h3>
